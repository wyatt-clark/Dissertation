...
\begin{centering}
	...
	\begin{subfigure}[b]{0.45\textwidth}
                \centering
                \includegraphics[width=\textwidth]{Figures/retesting/mfo_semantic_distance_unfiltered_normalized_2}
                \caption{$S_{2}$}
	...
	\begin{subfigure}[b]{0.45\textwidth}
                \centering
                \includegraphics[width=\textwidth]{Figures/retesting/mfo_lin_unfiltered_normalized_2}
        ...
        \end{subfigure}
        	...
        	\begin{subfigure}[b]{0.45\textwidth}
                \centering
                \includegraphics[width=\textwidth]{Figures/retesting/mfo_semantic_distance_unfiltered_normalized_4}
                \caption{$S_{2}$}
	...
	\begin{subfigure}[b]{0.45\textwidth}
                \centering
                \includegraphics[width=\textwidth]{Figures/retesting/mfo_lin_unfiltered_normalized_4}
                \caption{Excess Schlicker}
